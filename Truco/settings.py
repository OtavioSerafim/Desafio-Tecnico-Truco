"""
Django settings for Truco project.
...
SECRET_KEY = 'django-insecure-ze!akm9gkxdonvgo5!lyjeyhwp(g78ewtjjcc@%*e4!-1-t94v'
...
WSGI_APPLICATION = 'Truco.wsgi.application'
